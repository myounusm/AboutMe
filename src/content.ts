...
export const experience: ExperienceItem[] = [
  {
    ...
    summary: '',
    highlights: [
      'Lead technical architecture, solution design, engineering standards, and end-to-end delivery across enterprise insurance and digital transformation initiatives.',
      'Manage OutSystems LifeTime, including deployments across Development, UAT, and Production, along with hotfixes, rollbacks, release coordination, user access, roles, and permissions.',
      'Oversee production stability, troubleshoot critical application and integration issues, and manage incidents and service requests through ManageEngine.',
      'Mentor developers through technical guidance, solution reviews, code reviews, troubleshooting, performance optimization, security, and engineering best practices.',
      'Collaborate with business stakeholders, vendors, product teams, architects, and technology teams on release planning, impact analysis, technical risk assessment, and delivery of secure, scalable, and reliable enterprise solutions.',
    ],
    techStack:
  ...
  },
  {
    ...
    summary: '',
    highlights: [
      'Developed enterprise-grade OutSystems Reactive and Traditional Web applications for B2B, Partner Portal, quotation, policy issuance, renewals, payments, endorsements, and recovery processes.',
      'Built custom C#/.NET Extensions using Integration Studio, including email functionality, reusable components, and integration of external .NET libraries beyond standard OutSystems capabilities.',
      'Designed and consumed REST/SOAP APIs, integrating payment gateways, government services, internal insurance systems, SMS, WhatsApp, and third-party platforms.',
      'Worked extensively on AO Reduction, Advanced SQL, database optimization, application refactoring, performance tuning, Timers, background processing, caching, logging, and exception handling.',
      'Performed advanced debugging, root-cause analysis, technical-debt reduction, UAT support, production issue resolution, and permanent fixes for complex applications and integrations.',
    ],
    techStack:
